    ...
    content: (
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6 text-center">
        {[
          ...
          <div
            key={index}
            className="flex flex-col items-center opacity-90 hover:opacity-100 transition-opacity"
          >
            <img
              src={skill.src}
              alt={skill.label}
        ...
        {[
          {
            ...
            label: "GitHub Foundations – DevOps & CI/CD",
          },
          {
          ...
          { src: "/badges/badge4.png", label: "Docker Essentials – IBM" },
          {
            ...
            label: "Oracle Cloud AI Foundations Associate",
          },
          ...
          { src: "/badges/badge7.png", label: "Python – University of Moratuwa" },
          {
            ...
            label: "SQL & Relational Databases – IBM",
          },
